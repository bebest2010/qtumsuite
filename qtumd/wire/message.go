...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet QtumcoinNet) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet QtumcoinNet) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet QtumcoinNet, encoding MessageEncoding) (int, error) {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet QtumcoinNet,
...
func ReadMessageN(r io.Reader, pver uint32, btcnet QtumcoinNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet QtumcoinNet) (Message, []byte, error) {
